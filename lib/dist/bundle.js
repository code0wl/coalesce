...
class Draw extends engine_canvas_1.Canvas {
    constructor(width, height, logger, shapeCollection) {
        super(width, height);
        this.logger = logger;
        this.shapeCollection = shapeCollection;
        this.startEngine();
...
class AnimationLoop {
    constructor(context, width, height, logger, shapeCollection) {
        this.context = context;
        this.width = width;
        this.shapeCollection = shapeCollection;
        this.logger = logger;
    ...
    createLogger() {
        if (this.logger) {
            this.loggable = new engine_logger_1.Logger(this.shapeCollection);
        }
    }
    updateLogger() {
        if (this.logger) {
...
const engine_accelerometer_1 = __webpack_require__(70);
const engine_draw_1 = __webpack_require__(72);
const input_peripheral_1 = __webpack_require__(73);
const engine_collision_1 = __webpack_require__(71);
const engine_shape_collection_1 = __webpack_require__(74);
