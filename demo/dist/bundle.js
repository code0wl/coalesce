...
const engine_shape_collection_1 = __webpack_require__(19);
...
const engine_accelerometer_1 = __webpack_require__(352);
const engine_draw_1 = __webpack_require__(356);
const input_peripheral_1 = __webpack_require__(357);
const engine_collision_1 = __webpack_require__(355);
const engine_shape_collection_1 = __webpack_require__(19);
const json = __webpack_require__(73);
class PhysicsEngine {
    constructor(options) {
...
module.exports = {
	"_args": [
		[
			{
				"raw": "2d-physics-engine@../lib",
				"scope": null,
				"escapedName": "2d-physics-engine",
				"name": "2d-physics-engine",
				"rawSpec": "../lib",
				"spec": "/Users/oscarlodriguez/Dropbox/projects/2d-physics-engine/lib",
				"type": "directory"
			},
			"/Users/oscarlodriguez/Dropbox/projects/2d-physics-engine/demo"
		]
	],
	"_from": "../lib",
	"_id": "2d-physics-engine@0.1.1",
	"_inCache": true,
	"_location": "/2d-physics-engine",
	"_phantomChildren": {},
	"_requested": {
		"raw": "2d-physics-engine@../lib",
		"scope": null,
	...
	"_resolved": "file:../lib",
	"_shasum": "97f39efe08309160f730bb623d0dd7ad0291d9b5",
	"_shrinkwrap": null,
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(70), __webpack_require__(74)))
...
const engine_shape_collection_1 = __webpack_require__(19);
const engine_logger_1 = __webpack_require__(358);
class AnimationLoop {
...
const engine_animation_loop_1 = __webpack_require__(353);
const engine_vector_1 = __webpack_require__(38);
const engine_shape_circle_1 = __webpack_require__(359);
const engine_shape_rectangle_1 = __webpack_require__(360);
const engine_canvas_1 = __webpack_require__(354);
const engine_shape_collection_1 = __webpack_require__(19);
...
const rxjs_1 = __webpack_require__(76);
const controls_model_1 = __webpack_require__(351);
class InputKeyboard {
    constructor() {
...
const _2d_physics_engine_1 = __webpack_require__(71);
const controls_model_1 = __webpack_require__(72);
...
class Game {
    ...
    gameInput(keyCode) {
        if (keyCode >= controls_model_1.Controls.one && keyCode <= controls_model_1.Controls.nine) {
            if (keyCode - controls_model_1.Controls.one < _2d_physics_engine_1.ShapeCollection.collection.length) {
                _2d_physics_engine_1.ShapeCollection.selectedObject = keyCode - controls_model_1.Controls.one;
            }
        }
        switch (keyCode) {
            ...
            case controls_model_1.Controls.right:
                _2d_physics_engine_1.ShapeCollection.collection[_2d_physics_engine_1.ShapeCollection.selectedObject].rotate(-0.1);
                break;
            ...
            case controls_model_1.Controls.gravity:
                if (_2d_physics_engine_1.ShapeCollection.collection[_2d_physics_engine_1.ShapeCollection.selectedObject].fix === 0) {
                    _2d_physics_engine_1.ShapeCollection.collection[_2d_physics_engine_1.ShapeCollection.selectedObject].fix = 1;
                }
                else {
                    _2d_physics_engine_1.ShapeCollection.collection[_2d_physics_engine_1.ShapeCollection.selectedObject].fix = 0;
                }
                break;
    ...
    decrementObject() {
        if (_2d_physics_engine_1.ShapeCollection.selectedObject > 0) {
            _2d_physics_engine_1.ShapeCollection.selectedObject--;
        }
    }
    incrementObject() {
        if (_2d_physics_engine_1.ShapeCollection.selectedObject < _2d_physics_engine_1.ShapeCollection.collection.length - 1) {
            _2d_physics_engine_1.ShapeCollection.selectedObject++;
        }
    }
}
